<?php
    ...
    try {
        ...
        if ($search != NULL) {
            $items = query("SELECT * FROM contacts WHERE email LIKE :email", array(
                ':email' => $search
            ));
        }
        else {
            $items = query('SELECT * FROM contacts');
        }
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <th scope="row"><input name="emails[]" type="checkbox" value="<?php echo $contacts[$i]['email']; ?>"></th>
                                                <td><?php echo $contacts[$i]['email']; ?></td>
                                                <td><?php echo $contacts[$i]['message']; ?></td>
                                                <td>
                                                    <form method="post" action="newletter/sendemail.php">
                                                        <input name="emails[]" type="hidden" value="<?php echo $contacts[$i]['email']; ?>" >
                                                        <input type="submit" class="btn btn-primary" value="Send Email">
                                                        <a href="contact/delete.php?id=<?php echo $contacts[$i]['id']; ?>" class="btn btn-danger m-2">Delete</a>    
                                                    </form>
